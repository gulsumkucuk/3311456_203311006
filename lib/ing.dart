...
class TestYapisi {
  int aktif_sorum = 0;
  static List<Icon> d_y_bilgisi = [];
  static List d_y_bilgisi_state = [];
  List<Soru> Sorular = [
    Soru(
        soru_metni: "A- What’s Jack doing in the garden?",
        ...
        cevap: "A"),
    Soru(
        soru_metni: "We can’t make an omelet because ____",
        ...
        cevap: "B"),
    Soru(
        soru_metni: "A: ____ are these shoes?B: 50 TL.",
        a: " What size",
        b: "How old",
        c: "How many",
        d: "How much",
        cevap: "D"),
    Soru(
        soru_metni: "I can’t buy a car. _____",
        ...
        cevap: "B"),
    Soru(
        soru_metni: "A rabbit is _____ than a tortoise.",
        a: "slower",
        b: "faster",
        c: "hotter",
        d: "colder",
        cevap: "B"),
    Soru(
        soru_metni: "Making a cake is ____ making baklava.",
        ...
        cevap: "C"),
    Soru(
        soru_metni: "We can’t go swimming today because the sea is ____",
        a: "small",
        b: " easy",
        c: " warm",
        d: "cold",
        cevap: "D"),
    Soru(
        soru_metni: "We live ___ a big apartment ___ the third floor.",
        a: "in/on",
        b: "near/under",
        c: "on/behind",
        d: "between/next to",
        cevap: "A"),
    Soru(
        soru_metni: "In my free time, I mostly ______ a song.",
        a: "listen to",
        b: "speak to",
        c: "read",
        d: " write",
        cevap: "A"),
    Soru(
        soru_metni: "What would you like to have?",
    ...
    Soru(
        soru_metni:
            "A- Let’s go to play outside. B- It isn’t a good idea. ____",
        ...
        cevap: "B"),
    Soru(
        soru_metni: "We are going to have a holiday in Marmaris ----",
        a: "yesterday",
        b: "last week",
        c: "this July",
        d: "last summer",
  ...
  void cevabi_kontrol_et(String k_cevabi) {
    if (Sorular[aktif_sorum].Cevap == k_cevabi) {
      ...
      d_y_bilgisi_state.add(1);
    } else {
      d_y_bilgisi.add(
        Icon(Icons.close),
      );
      d_y_bilgisi_state.add(0);
    }
    sonraki_soruya_gec();
  }
}
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Wrap(
                      children: TestYapisi.d_y_bilgisi,
                    ),
                    SizedBox(
                      height: 10.0,
                    )
